...
function mainLoop (err, result) {
    ...
    switch (result) {
        ...
        case 'add':
            addressBook();
/*Your mission is to implement an add command that prompts the user 
for a contact's particular details and adds it to the myBook array, 
    which will be saved to the filesystem when you type exit.*/
            break;
        case 'busey':
